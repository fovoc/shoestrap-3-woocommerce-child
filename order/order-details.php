...
<?php
	if ($order->billing_email) echo __( '<i class="fa fa-envelope-o"></i> EMAIL : ', 'woocommerce' ).$order->billing_email.'<br />';
	if ($order->billing_phone) echo __( '<i class="fa fa-phone"></i> TELEPHONE : ', 'woocommerce' ).$order->billing_phone;
?>
</dl>
