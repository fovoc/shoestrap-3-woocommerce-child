...
class SS_WC_Widget_Layered_Nav extends WC_Widget {
	...
	public function widget( $args, $instance ) {
		global $_chosen_attributes, $ss_framework;
		...
		if ( count( $terms ) > 0 ) {
			...
			if ( $display_type == 'dropdown' ) {
				...
				if ( $current_tax && $taxonomy == $current_tax ) {
					...
					echo '<select class="' . $ss_framework->form_input_classes() . '" id="dropdown_layered_nav_' . $taxonomy_filter . '">';
				...
				foreach ( $terms as $term ) {
					...
					if ( isset( $_chosen_attributes[ $taxonomy ] ) && is_array( $_chosen_attributes[ $taxonomy ]['terms'] ) && in_array( $term->term_id, $_chosen_attributes[ $taxonomy ]['terms'] ) ) {
						...
						$class = 'class="active chosen list-group-item"';
					...
					echo '<a ' . $class . 'href="' . esc_url( apply_filters( 'woocommerce_layered_nav_link', $link ) ) . '">';
...
register_widget( 'SS_WC_Widget_Layered_Nav' );
