/**
 * foundation-multiselect.js
 *
 * Forked from https://github.com/davidstutz/bootstrap-multiselect by David Stutz
 * in order to support Foundation framework
 *
...
!function($) {
    ...
    Multiselect.prototype = {
        ...
        defaults: {
            ...
            buttonWidth: 'auto',
            buttonContainer: '<div class="button-group" />',
        ...
        templates: {
            button: '<button type="button" class="multiselect button dropdown" data-dropdown="drop1"></button>',
            ul: '<ul id="drop1" data-dropdown-content class="multiselect-container f-dropdown"></ul>',
            filter: '<div class="input-group"><span class="input-group-addon"></span><input class="form-control multiselect-search" type="text"></div>',
