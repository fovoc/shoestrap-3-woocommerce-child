...
<?php else : ?>
	...
	<form action="<?php echo esc_url( add_query_arg( 'address', $load_address, get_permalink( woocommerce_get_page_id('edit_address') ) ) ); ?>" method="post" class="form" id="customer_details">
		...
		<input type="submit" class="btn-default btn" name="save_address" value="<?php _e('Save Address', 'woocommerce'); ?>" />
