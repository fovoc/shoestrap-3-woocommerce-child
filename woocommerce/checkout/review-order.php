...
<div id="order_review">
	...
	<div id="payment" class="well">
			...
			<?php
				...
				if ( ! empty( $available_gateways ) ) {
					...
					foreach ( $available_gateways as $gateway ) {
						?>
						<div class="clearfix">
							<div class="radiobutton"><input type="radio" id="payment_method_<?php echo $gateway->id; ?>" class="input-radio" name="payment_method" value="<?php echo esc_attr( $gateway->id ); ?>" <?php checked( $gateway->chosen, true ); ?> /></div>
							<div class="description">
							<label for="payment_method_<?php echo $gateway->id; ?>"><?php echo $gateway->get_title(); ?> <?php echo $gateway->get_icon(); ?></label> <br>
							<?php
								if ( $gateway->has_fields() || $gateway->get_description() ) :
									echo '<div class="payment_box payment_method_' . $gateway->id . '" ' . ( $gateway->chosen ? '' : 'style="display:none;"' ) . '><small>';
		...
		<div class="form-row place-order clearfix text-center">
			...
			echo apply_filters('woocommerce_order_button_html', '<input type="submit" class="btn theme alt" name="woocommerce_checkout_place_order" id="place_order" value="' . $order_button_text . '" />' );
			?>
