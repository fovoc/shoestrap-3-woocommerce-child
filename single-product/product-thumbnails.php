		...
		<?php }
			...
			foreach ( $attachment_ids as $attachment_id ) {
				...
				$image_title = esc_attr( get_the_title( $attachment_id ) );
					...
					echo apply_filters( 'woocommerce_single_product_image_thumbnail_html', sprintf( '<li><a href="%s" class="%s" rel="thumbnails">%s</a></li>', $image_link, $image_class, $image), $attachment_id, $post->ID, $image_class );
